...
A script (CreateInputMNL.r in https://github.com/lguillier/ABSA/tree/master/R/ )was developped to prepare i) the input file for multinomial logistic model training/testing/fitting and ii) the input file for predicting the source of unknwon strains 
